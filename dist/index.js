...
})(this, function(__WEBPACK_EXTERNAL_MODULE_7__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_15__, __WEBPACK_EXTERNAL_MODULE_16__, __WEBPACK_EXTERNAL_MODULE_17__, __WEBPACK_EXTERNAL_MODULE_19__, __WEBPACK_EXTERNAL_MODULE_41__) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _feedback2 = __webpack_require__(8);
	...
	var _Proposal = __webpack_require__(13);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function GetProposal(id) {
	    ...
	    return (0, _DatabaseHelpers.GetData)("proposals", id);
	}
	function GetProposals() {
	    var entryMap = (0, _DatabaseHelpers.GetData)("proposals");
	    return (0, _VCache.CachedTransform)("GetProposals", [], entryMap, function () {
...
/***/ (function(module, exports) {
	...
	var Proposal = exports.Proposal = function Proposal(initialData) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reactVcomponents = __webpack_require__(17);

	var _reactVscrollview = __webpack_require__(18);

	var _FirebaseConnect = __webpack_require__(20);

	var _Manager = __webpack_require__(2);

	var _ProposalEntryUI = __webpack_require__(21);

	var _ProposalDetailsUI = __webpack_require__(23);

	var _feedback = __webpack_require__(8);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		if(true)
			module.exports = factory(__webpack_require__(15), __webpack_require__(19));
		else if(typeof define === 'function' && define.amd)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.ProposalEntryUI = ProposalEntryUI = __decorate([(0, _FirebaseConnect.Connect)(function (state, _ref) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.ProposalDetailsUI = undefined;

	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

	exports.ShowAddProposalDialog = ShowAddProposalDialog;
	...
	var _MarkdownToolbar = __webpack_require__(24);

	var _Link = __webpack_require__(22);

	var _reactMdEditor = __webpack_require__(33);

	var _reactMdEditor2 = _interopRequireDefault(_reactMdEditor);

	var _jsVextensions = __webpack_require__(10);

	var _reactVmessagebox = __webpack_require__(41);

	var _feedback = __webpack_require__(5);

	var _AddProposal = __webpack_require__(42);
	...
	var ProposalDetailsUI = exports.ProposalDetailsUI = function (_BaseComponent) {
	    _inherits(ProposalDetailsUI, _BaseComponent);

	    function ProposalDetailsUI() {
	        _classCallCheck(this, ProposalDetailsUI);

	        return _possibleConstructorReturn(this, (ProposalDetailsUI.__proto__ || Object.getPrototypeOf(ProposalDetailsUI)).apply(this, arguments));
	    }
	    ...
	    _createClass(ProposalDetailsUI, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement("div", null, " ", _react2.default.createElement(_reactVcomponents.Column, { style: style }, _react2.default.createElement(_reactVcomponents.RowLR, { mt: 5, splitAt: splitAt, style: { width: width } }, _react2.default.createElement(_reactVcomponents.Pre, null, "Title: "), _react2.default.createElement(_reactVcomponents.TextInput, { required: true, enabled: enabled, style: { width: "100%" }, value: newData.title, onChange: function onChange(val) {
	                ...
	                } })), _react2.default.createElement(_reactVcomponents.RowLR, { mt: 5, splitAt: splitAt, style: { width: width } }, _react2.default.createElement(_reactVcomponents.Column, null, enabled && _react2.default.createElement(_MarkdownToolbar.MarkdownToolbar, { editor: function editor() {
	                ...
	                return regeneratorRuntime.wrap(function _callee$(_context) {
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            case 0:
	                                _context.next = 2;
	                                return new _AddProposal.AddProposal({ data: newEntry }).Run();

	                            case 2:
	                                id = _context.sent;

	                                store.dispatch(new _feedback.ACTProposalSelect({ id: id }));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Formatter = __webpack_require__(32);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
		bold: __webpack_require__(26),
		italic: __webpack_require__(27),
		link: __webpack_require__(28),
		uList: __webpack_require__(29),
		oList: __webpack_require__(30),
		quote: __webpack_require__(31)
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _formatJs = __webpack_require__(34);

	var classNames = __webpack_require__(35);
	var CM = __webpack_require__(36);
	var React = __webpack_require__(15);
	var ReactDOM = __webpack_require__(19);
	var Icons = __webpack_require__(25);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function(mod) {
	  if (true) // CommonJS
	    mod(__webpack_require__(36), __webpack_require__(37), __webpack_require__(39));
	  else if (typeof define == "function" && define.amd) // AMD
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.AddProposal = undefined;

	var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

	var _Command2 = __webpack_require__(43);
	...
	var AddProposal = exports.AddProposal = function (_Command) {
	    _inherits(AddProposal, _Command);

	    function AddProposal() {
	        _classCallCheck(this, AddProposal);

	        return _possibleConstructorReturn(this, (AddProposal.__proto__ || Object.getPrototypeOf(AddProposal)).apply(this, arguments));
	    }
	                    ...
	                    while (1) {
	                        switch (_context.prev = _context.next) {
	                            case 0:
	                                ...
	                                _context.next = 3;
	                                return (0, _DatabaseHelpers.GetDataAsync)("general", "lastProposalID");
